...
if (!isset($_SESSION['login']) || $_SESSION['login'] !== true) {
    logActivity("UNAUTHORIZED", "Unauthorized access attempt to Delete Home.");
...
if ($delete) {
    logActivity("DELETE", "Home ID $id deleted successfully");
	echo "<script type='text/javascript'>Berhasil di Hapus</script>";
} else {
    logActivity("DELETE_FAIL", "Failed to delete Home ID $id.");
