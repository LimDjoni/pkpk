...
if (!isset($_SESSION['login']) || $_SESSION['login'] !== true) {
    logActivity("UNAUTHORIZED", "Unauthorized access attempt to Delete Annual Report.");
...
if ($delete) {
    logActivity("DELETE", "Annual Report ID $id deleted successfully");
	echo "<script type='text/javascript'>Berhasil di Hapus</script>";
} else {
    logActivity("DELETE_FAIL", "Failed to delete Annual Report ID $id.");
