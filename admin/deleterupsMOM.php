...
if (!isset($_SESSION['login']) || $_SESSION['login'] !== true) {
    logActivity("UNAUTHORIZED", "Unauthorized access attempt to Delete RUPS MOM.");
...
if ($delete) {
    logActivity("DELETE", "RUPS Minutes of Meeting ID $id deleted successfully");
	echo "<script type='text/javascript'>Berhasil di Hapus</script>";
} else {
    logActivity("DELETE_FAIL", "Failed to delete RUPS Minutes of Meeting ID $id.");
