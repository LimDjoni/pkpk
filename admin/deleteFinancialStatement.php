...
if (!isset($_SESSION['login']) || $_SESSION['login'] !== true) {
    logActivity("UNAUTHORIZED", "Unauthorized access attempt to Delete Financial Statement.");
...
if ($delete) {
    logActivity("DELETE", "Financial Statement ID $id deleted successfully");
	echo "<script type='text/javascript'>Berhasil di Hapus</script>";
} else {
    logActivity("DELETE_FAIL", "Failed to delete Financial Statement ID $id.");
