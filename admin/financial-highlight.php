<?php 
$title = "Financial Highlight | Paragon Karya Perkasa, Tbk"; 
		...
		<div class="content-wrapper">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Financial Highlight</li>
							</ol>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Data Financial Highlight</h1>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			</section>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-12">  
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Data Financial Highlight</h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body"> 
										...
										<tbody>
											...
											<?php }else{  for ($x = 0; $x < count($decoded); $x++) { ?>   
												<tr>
													...
													<td>
														<a href="editFinancialHighlight?id=<?php echo $decoded[$x]['ID_Laporan']; ?>" name="edit" class="btn btn-primary">Edit</a> 
														<a href="#myModal" class="btn btn-danger" data-href="deleteFinancialHighlight?id=<?php echo $decoded[$x]['ID_Laporan']; ?>" data-toggle="modal" data-target="#myModal">Delete</a> 
													</td>
												</tr>
												<?php $no++; }
											}?>
