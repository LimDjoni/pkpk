<!-- Header -->
<?php $title = "Shareholders Information | PKPK";
$page = "kepemilikan-saham"; 
							...
							<table class="table table-bordered"> 
								<thead> 
									<tr style="color:white; background-color: red;">
										...
										<th scope="col" style="text-align: center;">Shareholders Name</th>
										<th scope="col" style="text-align: center;">Number of Share</th>
