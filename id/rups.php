<!-- Header -->
<?php $title = "Rapat Umum Pemegang Saham | PKPK";
$page = "general-meeting-shareholders"; 
	...
	<section class="testimonial-section">
		<div class="container">
			<div class="row justify-content-center">  
				<button class="button active" onClick="overviewFunction(this)"><a>Pemberitahuan RUPS</a></button>
				<button class="button" onClick="remunerationFunction(this)"><a>Undangan RUPS</a></button>
				<button class="button" onClick="nominatingFunction(this)"><a>Risalah Rapat RUPS</a></button> 
			</div>
		</div>
	</section>
