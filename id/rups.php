	...
	<section class="testimonial-section">
		<div class="container">
			<div class="row justify-content-center">  
				<button class="button active" onClick="overviewFunction(this)">Pemberitahuan RUPS</button>
				<button class="button" onClick="remunerationFunction(this)">Undangan RUPS</button>
				<button class="button" onClick="nominatingFunction(this)">Risalah Rapat RUPS</button> 
			</div>
		</div>
	</section>
